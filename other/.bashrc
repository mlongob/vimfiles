...
COL_DEFAULT="\[\033[0m\]"
COL_UNAME="`EXT_COLOR 202`"
COL_MACHINE="`EXT_COLOR 204`"
COL_PATH="`EXT_COLOR 77`"
COL_REST="`EXT_COLOR 227`"
export PS1="${COL_UNAME}\u${COL_REST}@${COL_MACHINE}\h${COL_REST}:${COL_PATH}\w${COL_REST} \$\[\e[m\] "
...
alias vi='vim'
alias cdscrp='cd ~/mbig/scrp.git'
alias cdmsgscrape='cd ~/mbig/scrape.git/msgscrape'
alias bilbo='history | grep'
export SCRP_GIT_DIR="~/mbig/scrp.git"
export SCRPBUILD_DIR="/bb/bigstorq4/scrpbuild"
